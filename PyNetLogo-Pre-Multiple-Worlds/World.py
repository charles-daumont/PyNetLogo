...
class World():
    ...
    #    - world_name           : name of the world
    ###
    def __init__(self, patches_size=[10, 10], patches_number=[20, 20], world_name=""):
    ...
    ###       
    def reset(self):
        self = self.__init__(self.patches_size, self.patches_number, self.name)
    ...
    ###    
    def create(self, category="Turtle", nb_turtles=1, params=[]):

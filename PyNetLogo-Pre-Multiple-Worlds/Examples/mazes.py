...
turtles_methods_dictionnary = {"report_wall": report_wall, "behaviour_wall_following":behaviour_wall_following, "walk":walk, "behaviour_random_forward_0":behaviour_random_forward_0, "behaviour_random_forward_1":behaviour_random_forward_1, "behaviour_random_forward_2":behaviour_random_forward_2}
patches_methods_dictionnary = {"setup_empty_maze": setup_empty_maze, "close_door":close_door, "setup_row":setup_row, "setup_col":setup_col, "setup_hampton_court_maze":setup_hampton_court_maze, "setup_chevening_house_maze":setup_chevening_house_maze}
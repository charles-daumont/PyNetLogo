...
turtles_methods_dictionary = {"actions": file_behaviour.actions, "move":move, "turn_left":turn_left, "turn_right":turn_right, "food_ahead":food_ahead, "food_on_my_left":food_on_my_left, "food_on_my_right":food_on_my_right, "food_ALR":food_ALR, "food_direction":food_direction}
patches_methods_dictionary = {"add_food": add_food, "add_gap": add_gap, "food":food}
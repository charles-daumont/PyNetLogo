...
maze_being_searched = "Empty Maze" # Empty Maze, Hampton Court Maze, Chevening House Maze
left_cols = 40
right_cols = 40
below_rows = 40
above_rows = 40
...
def go():
    ask(all("Turtle"), [("walk_2",())])


turtles_methods_dictionary = {"report_wall": report_wall, "behaviour_wall_following":behaviour_wall_following, "walk_2":walk_2, "behaviour_random_forward_0":behaviour_random_forward_0, "behaviour_random_forward_1":behaviour_random_forward_1, "behaviour_random_forward_2":behaviour_random_forward_2}
